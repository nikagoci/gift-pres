...
const Header = () => {
  return (
    <>
      <div className="z-10 flex flex-col items-center lg:flex-1 gap-y-10 lg:gap-y-16">      
      ...
      <div className="flex items-center justify-center lg:flex-1">
        <div className="max-w-[500px] lg:w-[900px] lg:h-[900px] max-h-[400px] z-10 flex justify-center ">
          <img
