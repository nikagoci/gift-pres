  ...
  return (
    <>
      <section className="relative py-8 header-height z-20 bg-left-bottom w-full bg-[url('https://vault.uicore.co/speaker/wp-content/uploads/sites/23/2022/06/Speaker-Hero-Image-BG.webp')]">
        ...
        <div className="w-[200px] md:w-[500px] h-auto z-40 absolute left-1/2 -translate-x-1/2 md:translate-x-0 top-[60%] md:top-1/2 md:right-20 md:-translate-y-1/2">
          <img
        ...
        <div className="container relative z-30 h-full mx-auto text-white">
          <div className="flex flex-col pt-15 md:pt-0 md:justify-center h-full gap-y-16 w-full md:max-w-[50%]">
            <h1 className="text-2xl text-center text-indigo-300 capitalize sm:text-3xl">
              Join us in our mission to provide clothing and essentials to those
              in need.
            </h1>
            <p className="text-base leading-8 text-center capitalize sm:text-xl">
